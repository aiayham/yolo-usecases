...
TRACK_CLASSES = ["car", "bus", "truck", "minivan"]
...
CLASS_RGB = {        # PIL uses (R,G,B)
    "car":     ( 52, 199,  89),   # green
    "bus":     (255, 159,  10),   # orange
    "truck":   (255,  69,  58),   # red
    "minivan": ( 10, 132, 255),   # blue
    "unknown": (160, 160, 160),
}
...
# ── Video & tracker ────────────────────────────────────────────────────────────
cap     = cv2.VideoCapture("D:/yolo/videos/1.mp4")
mask    = cv2.imread("D:/yolo/videos/1mask.png")
